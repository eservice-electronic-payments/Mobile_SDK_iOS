...
SWIFT_CLASS("_TtC14ipworks3ds_sdk16AddrFamilyAccept")
@interface AddrFamilyAccept : NSObject <StringObfuscatorNewDeviceParamValueType>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)whileAuthResponse:(NSData * _Null_unspecified)dataPacket;
- (void)endifUiCustomization:(NSData * _Null_unspecified)dataPacket;
- (void)isRuntimeHookedCheck:(int32_t)errorCode :(NSString * _Null_unspecified)description;
- (void)clientConfigsGetppidType:(int32_t)logLevel :(NSString * _Null_unspecified)message :(NSString * _Null_unspecified)logType;
- (void)loadedDylibNameWarningList:(NSData * _Null_unspecified)certEncoded :(NSString * _Null_unspecified)certSubject :(NSString * _Null_unspecified)certIssuer :(NSString * _Null_unspecified)status :(int32_t * _Nonnull)accept;
- (void)certArrayDlsym:(NSString * _Null_unspecified)message;
@end
...
SWIFT_CLASS("_TtC14ipworks3ds_sdk13ContainsUsing")
@interface ContainsUsing : NSObject
+ (void)getHeadingTextFontNameGetTextColor;
+ (void)uIImageViewTextBoxCustomization;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
